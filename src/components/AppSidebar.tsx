...
const items: NavItem[] = [
  ...
  { title: "مستهدفات فريقي", url: "/team-targets", icon: Target, roles: ["department_entry", "admin"] },
  { title: "مستهدفات الإدارة", url: "/department-goals", icon: Target, roles: ["department_entry", "department_admin", "admin", "stakeholder", "data_manager"] },
